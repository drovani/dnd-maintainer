...
describeUpdateMutation('useUpdateNote', () => renderHook(() => useUpdateNote(), { wrapper: createWrapper() }), {
  id: 'note-1',
  title: 'Updated Title',
});

describeDeleteMutation('useDeleteNote', () => renderHook(() => useDeleteNote(), { wrapper: createWrapper() }), {
  id: 'note-1',
});
