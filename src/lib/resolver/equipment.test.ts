      ...
      persistedItems: [
        {
          ...
          quantity: 1,
          equipped: true,
          source: { origin: 'bundle' as const, id: 'fighter-chainmail' },
        },
        {
          itemId: 'longsword',
          quantity: 1,
          equipped: true,
          source: { origin: 'bundle' as const, id: 'longsword-and-shield' },
        },
      ],
    };
...
describe('resolveEquippedArmorAc', () => {
  ...
  it('shield adds shieldBonus 2', () => {
    const result = resolveEquippedArmorAc([makeEquippedArmor('chain-mail'), makeEquippedArmor('shield')], 0);
    expect(result).not.toBeNull();
