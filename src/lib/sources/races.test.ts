...
describe('Mountain Dwarf race source', () => {
  ...
  it('grants Common and Dwarvish languages', () => {
    const languages = source?.grants.filter(
  ...
  it('grants light and medium armor proficiency', () => {
    const armor = source?.grants.filter(
      (g) => g.type === 'proficiency' && g.category === 'armor',
    )
  ...
  it('grants dwarven weapon proficiencies', () => {
    const weapons = source?.grants.filter(
      (g) => g.type === 'proficiency' && g.category === 'weapon',
    )
