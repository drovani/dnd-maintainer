...
export const CHARACTER_SUMMARY_COLS = 'id, slug, previous_slugs, campaign_id, name, player_name, character_type, race, class, subclass, level, hit_points_max, armor_class, updated_at' as const;
...
export const SESSION_SUMMARY_COLS = 'id, slug, previous_slugs, campaign_id, session_number, name, date, summary, experience_awarded, created_at, updated_at' as const;
