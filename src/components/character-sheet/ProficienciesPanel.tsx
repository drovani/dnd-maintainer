...
import type { ArmorProficiencyId, LanguageId, ToolProficiencyId, WeaponProficiencyId } from '@/lib/dnd-helpers';
...
export function ProficienciesPanel({ resolved }: ProficienciesPanelProps) {
  ...
  return (
    <div className="bg-card border rounded-lg p-6">
      <h2 className="text-lg font-bold text-foreground mb-4">{tc('characterSheet.sections.proficiencies')}</h2>
