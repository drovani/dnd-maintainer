...
VALUES
  ...
  ('aaaaaaaa-0000-4000-8000-000000000001', 'Erdan Siannodel',        'pc', 'elf',        'ranger',    'guide',       'ng', 1, 'ready', true),
  ('aaaaaaaa-0000-4000-8000-000000000001', 'Bharash Daardendrian',   'pc', 'dragonborn', 'paladin',   'noble',       'lg', 1, 'ready', true),
  ('aaaaaaaa-0000-4000-8000-000000000001', 'Mara Stoneheart',        'pc', 'human',      'barbarian', 'farmer',      'cn', 1, 'ready', true),
